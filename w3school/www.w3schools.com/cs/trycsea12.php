...
<!-- Mirrored from www.w3schools.com/cs/trycs.php?filename=demo_oper_ass7 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Aug 2024 16:47:52 GMT -->
...
<link rel='stylesheet' href='../lib/codemirror_multi.css'><script src='../lib/codemirror_multi.js'></script><script src='../lib/codemirror_clike.js'></script><!-- Google Tag Manager -->
<script>
...
<span onclick="openMenu()" class="w3-button w3-display-topright w3-transparent ws-hover-black" title="Close Menu" style="font-weight:bold;padding-top:10px;padding-bottom:11px;">&times;</span>
  ...
  <a style="display:inline;padding:0;" href="https://www.w3schools.com/about/about_copyright.asp" target="_blank" onclick="openMenu();" class="w3-hover-none ws-hover-text-green ga-tryit">Copyright 1999-2024</a></p>
  </footer>
</div>
...
namespace MyApplication
{
  ...
  <div id="iframecontainer">
    <div id="iframe">
            ...
            <div class='iframeResult' style='position:relative;white-space:nowrap;overflow:auto;' id='resultdiv_0'><div>1</div></div>
